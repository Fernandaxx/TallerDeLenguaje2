...
public class MonedaDAOnew implements IMonedaDAO {
    ...
    private void actualizarMonedaCripto(Connection c, Moneda moneda) throws
       SQLException {
       String sql = esCripto
       ?
       "UPDATE MONEDA SET VALOR_DOLAR = ?, VOLATILIDAD = ?, STOCK = ? WHERE
       NOMENCLATURA = ?"
    ...
    private void actualizarMonedaFiat(Connection c, Moneda moneda, boolean
    ...
    private void insertarCripto(Connection c, Criptomoneda criptomoneda) throws
       SQLException {
       String sql =
       "INSERT INTO MONEDA (TIPO, NOMBRE, NOMENCLATURA, VALOR_DOLAR, VOLATILIDAD,
       STOCK) VALUES (?, ?, ?, ?, ?, ?)"
       ;
